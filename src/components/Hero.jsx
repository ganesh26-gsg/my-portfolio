  ...
  return (
    <section className="container mx-auto px-4 text-center pt-24 md:pt-40">
      ...
      >
        ...
        <motion.p
          className="text-lg md:text-xl text-gray-700 max-w-2xl mx-auto mb-8 dark:text-gray-300"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
        ...
        <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
          ...
          <motion.a
            ...
            className="px-8 py-3 border border-gray-300 text-gray-700 rounded-full font-semibold text-lg shadow-lg hover:border-purple-500 hover:text-purple-500 transform hover:scale-105 transition duration-300 flex items-center justify-center dark:border-gray-600 dark:text-gray-300 dark:hover:border-purple-500 dark:hover:text-purple-500"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
            whileInView={{ opacity: 1, y: 0 }}
