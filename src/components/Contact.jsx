  ...
  return (
    <section className="container mx-auto px-4 py-16 md:py-24">
      ...
      <div className="flex flex-col md:flex-row gap-12 justify-center items-center">
        ...
        >
          <h3 className="text-4xl font-bold text-white mb-6">Let's <span className="text-purple-500">talk</span></h3>
        ...
        <motion.div
          className="md:w-1/2 bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-700"
          initial={{ opacity: 0, x: 50 }}
          whileInView={{ opacity: 1, x: 0 }}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-5 py-3 bg-gray-700 text-white rounded-md border border-gray-600 focus:outline-none focus:border-purple-500 placeholder-gray-400"
                required
              />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full px-5 py-3 bg-gray-700 text-white rounded-md border border-gray-600 focus:outline-none focus:border-purple-500 placeholder-gray-400 resize-y"
                required
              ></textarea>
            </div>
